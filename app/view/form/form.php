<form class="form" action="post" enctype="multipart/form-data">
    ...
    <div class="form__input-group">
        ...
        <label class="form__label form__label--small"> <input data-show-group="percent-change" class="form__input form__input--radio" required type="radio" name="resize-method"> Percent change</label>
        ...
        <label class="form__label form__label--small"> <input data-show-group="specify-size" required class="form__input form__input--radio" type="radio" name="resize-method"> Specific size</label>
